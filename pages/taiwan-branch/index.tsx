    ...
    <>
      ...
      <div className="mx-auto py-8 px-8 object-strategy grid grid-cols-2 gap-6">
        <div className="objective">
          ...
          <ul className="mt-5">
            <li>
              <p>Expand service network and strengthen existing business partnerships</p>
            </li>
            <li>
              <p>Recognize gaps in the market and develop innovative ideas to seize market opportunities</p>
            </li>
            <li>
              <p>Understand customer needs and provide efficient and professional services to meet customer needs</p>
            </li>
          </ul>
        </div>
        <div className="strategy">
          ...
          <ul className="mt-5">
            <li>
              <p>Respect customers&apos; different perspectives and promote cultural communication between local and overseas countries in the healthcare field</p>
            </li>
            <li>
              <p>Use network connections to increase investment opportunities</p>
            </li>
            <li>
              <p>Develop marketing strategies such as sponsorship and participation in academic exchanges, and create and strengthen business ties with relevant international fields</p>
            </li>
          </ul>
        </div>
      </div>
